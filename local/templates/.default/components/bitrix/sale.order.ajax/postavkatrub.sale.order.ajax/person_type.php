    ...
    <div class="section">
        ...
        <?foreach($arResult["PERSON_TYPE"] as $v):?>
            <div class="label left">
                <input type="radio" style="display: none" id="PERSON_TYPE_<?=$v["ID"]?>" name="PERSON_TYPE" value="<?=$v["ID"]?>"<?if ($v["CHECKED"]=="Y") echo " checked=\"checked\"";?> onClick="submitForm()">
        <label for="PERSON_TYPE_<?=$v["ID"]?>"><div class="bx_logotype"><span></span></div><?=$v["NAME"]?></label><br />
            </div>
            <?endforeach;?>
        <div class="clear"></div>
