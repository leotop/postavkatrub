...
<table class="order-auth">
    ...
    <tr>
        <td>
            <form method="post" action="" class="login_order_form" name="order_auth_form">
                <?=bitrix_sessid_post()?>
                <?
            ...
            <?if($arResult["AUTH"]["new_user_registration"]=="Y"):?>
                <form method="post" action="" name="order_reg_form">
                    ...
                    <table class="sale_order_full_table">
                        ...
                        <tr>
                            <td nowrap><input type="radio" style="display: none" id="NEW_GENERATE_N" name="NEW_GENERATE" value="N" OnClick="ChangeGenerate(true)"<?if ($_POST["NEW_GENERATE"] != "N") echo " checked";?>> <label for="NEW_GENERATE_N">                                
                            <div class="bx_logotype">
                                    <span <?/*style="background-image:url(<?=$imgUrl?>);"*/?>></span>
                                </div><?echo GetMessage("STOF_MY_PASSWORD")?></label></td>
                        </tr>
                        <?endif;?>
                        <?if($arResult["AUTH"]["new_user_registration_email_confirmation"] != "Y"):?>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <input type="radio" style="display: none" id="NEW_GENERATE_Y" name="NEW_GENERATE" value="Y" OnClick="ChangeGenerate(false)"<?if ($POST["NEW_GENERATE"] == "N") echo " checked";?>> <label for="NEW_GENERATE_Y">                                <div class="bx_logotype">
                                    <span <?/*style="background-image:url(<?=$imgUrl?>);"*/?>></span>
                                </div><?echo GetMessage("STOF_SYS_PASSWORD")?></label>
