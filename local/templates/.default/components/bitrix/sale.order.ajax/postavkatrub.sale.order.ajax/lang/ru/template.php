...
$MESS['SOA_TEMPL_ORDER_SUC1'] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Личном кабинете</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
...
$MESS['SBERBANK_PAY_INFO'] = "О том как оплатить ваш заказ через сервис Сбербанк Эквайринг, вы может узнать <a href='/personal/sberbank_pay_info/' target='_blank'>далее</a>";
$MESS['SBERBANK_PAY_NOT_AVAILABLE'] = "Оплата онлайн в данный момент недоступна, так как выбран товар отсутвующий на складе.<br>Вы сможете оплатить заказ банковской картой в личном кабинете после подтверждения заказа менеджером.";
?>