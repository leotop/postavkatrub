		...
		<div style="display:none;">
			...
			&nbsp;
				...
				<div class="cart-ordering">
					<div class="cart-buttons cart-buttons-order">
						<button type="button" class="bButton" name="submitbutton" onClick="submitForm('Y');" value="<?=GetMessage("SOA_TEMPL_BUTTON")?>"><span><?=GetMessage("SOA_TEMPL_BUTTON")?></span></button>
					</div>
				</div>
			</div>
		</div>
