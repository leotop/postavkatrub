                                    ...
                                    <tr id="YS_BS_ROW_<?=$i;?>">
                                        ...
                                        <td class="yen-bs-t_count">
                                            <?if($arParams['CHANGE_QUANTITY'] != 'Y'):?>
                                                ...
                                                <input autocomplete="off" type="text" name="YS_BS_QUANTITY_<?=$arItem['ID'];?>" id="YS_BS_QUANTITY_<?=$i;?>" value="<?=$arItem["QUANTITY"];?>" class="yen-bs-txt yen-bs-w32 yen-bs-q" onchange="yen_setQuantity('<?=$i;?>', 'c', <?=$arItem['PRODUCT_ID'];?>, <?=$arItem['MEASURE'];?>); return false;">
                                                <button onclick="yen_setQuantity('<?=$i;?>', 'p', <?=$arItem['PRODUCT_ID'];?>, <?=$arItem['MEASURE'];?>); return false;" class="yen-bs-button4" title="<?=GetMessage('YS_BS_BUTTON_PLUS');?>">+</button> <button onclick="yen_setQuantity('<?=$i;?>', 'm', <?=$arItem['PRODUCT_ID'];?>, <?=$arItem['MEASURE'];?>); return false;" class="yen-bs-button5" data-measure="<?echo $arItem['CATALOG_MEASURE_RATIO']?>" title="<?=GetMessage('YS_BS_BUTTON_MINUS');?>">-</button>
                                                <?else:?>
