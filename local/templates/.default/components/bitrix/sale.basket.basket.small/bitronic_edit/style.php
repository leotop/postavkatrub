...
else
{
	...
	echo 'div.yen-bs-box{top:'.$margin_top.'px ; left:'.$margin_side.'px; z-index:'.$z_index_box.' !important;} div.yen-bs-popup {left:-525px;} div.yen-bs-rasp {left:0px !important;} div.yen-bs-up {z-index:'.$z_index_up.' !important;}'; 
}
echo ' div.yen-bs-scrollBasket {top:0px !important;}';
?>