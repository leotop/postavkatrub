...
<?if(CModule::IncludeModule('iblock')):?>
	<?
		...
		if(!empty($res['CODE'])){
			$arItem['URL'] = str_replace($res['CODE'],$res['ID'],$arItem['URL']);
		}
	?>
<?endif?>
<?php
...
<?php
  /*
?>      
        <h4><a href="/catalog/<?=$ar_res['IBLOCK_SECTION_ID']?>/<?=$ar_res['ID']?>/"><?echo $arItem["TITLE_FORMATED"]?></a></h4>
<?php
  */
?>      
<?php
...
?>      
				...
				<h4><a href="<?=$arItem['URL']?>"><?echo $arItem["TITLE_FORMATED"]?></a></h4>
