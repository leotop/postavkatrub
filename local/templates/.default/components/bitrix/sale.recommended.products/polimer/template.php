...
<? if (isset($arResult['ITEMS']) && !empty($arResult['ITEMS'])): ?>
	<div
		class="bx_item_list_recommended col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> also">
...
<!--	<div id="slider1">
		...
		<div class="viewport">
			<ul class="overview">
				...
				<li><img src="/upload/images/brands/8.jpg"></li>
				...
				<li><img src="/upload/images/brands/3.jpg"></li>
...
<div id="slider2">
	...
	<a id="<? echo $arItemIDs['PICT']; ?>"
		...
		?>
        <img src="<? echo($arParams['SHOW_IMAGE'] == "Y" ? $arItem['PREVIEW_PICTURE']['SRC'] : ""); ?>"/>
	</a><?
	...
	{
		?>
	<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_title"
