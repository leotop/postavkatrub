                                ...
                                <div class="sale-order-list-inner-row-body">
                                    ...
                                    <div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-payment">
                                        ...
                                        <?
                                            ...
                                            <div class="sale-order-list-payment-price">
                                                <span class="sale-order-list-payment-element"><?=Loc::getMessage('SPOL_TPL_PAY_TYPE')?>:</span>
                                                <span class="sale-order-list-payment-number"><?=$payment['PAY_SYSTEM_NAME']?></span>
                                            </div>
