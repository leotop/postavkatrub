...
<div class="product-block clearfix">
    ...
    <div class="product-descr">
        ...
        <div class="price_row">
            ...
            <input class="quant2" type="text" id="quantity2_<?=$arResult['ID']; ?>" value="<?if ($arResult["PROPERTIES"]["KOEFFITSIENT"]["VALUE"]){ echo $arResult["PROPERTIES"]["KOEFFITSIENT"]["VALUE"]; } else { echo "1"; }?>" data-measure="<?if($arResult["PROPERTIES"]["KOEFFITSIENT"]["VALUE"]){ echo $arResult["PROPERTIES"]["KOEFFITSIENT"]["VALUE"]; } else { echo '1'; }?>" >
