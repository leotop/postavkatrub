...
<script>
    $(function() {
        ...
        $('.cart-item-quantity input:text').keyup(function() {
                                            ...
                                            <tr>
                                                ...
                                                <?if (in_array("QUANTITY", $arParams["COLUMNS_LIST"])):?>
                                                    <td class="cart-item-quantity">
                                                        <input class="cart-item-quantity-input" maxlength="15" type="text" name="QUANTITY_<?=$arBasketItem["ID"] ?>" value="<?=$arBasketItem["QUANTITY"]?>" size="3" onkeyup="validateInt(this)">
