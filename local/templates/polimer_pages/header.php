...
<?$APPLICATION->IncludeComponent("bitrix:breadcrumb", ".default", Array(
        ...
        "SITE_ID" => "-",    // CР°Р№С‚ (СѓСЃС‚Р°РЅР°РІР»РёРІР°РµС‚СЃСЏ РІ СЃР»СѓС‡Р°Рµ РјРЅРѕРіРѕСЃР°Р№С‚РѕРІРѕР№ РІРµСЂСЃРёРё, РєРѕРіРґР° DOCUMENT_ROOT Сѓ СЃР°Р№С‚РѕРІ СЂР°Р·РЅС‹Р№)
        ),
        false
    );?>
...
<div class="main-column <?if ($APPLICATION->GetCurPage()=='/personal/order/make/') {echo 'margintop7';}?>">
...
<h1 class="page-title" style='margin-bottom:10px;'>
    <?
        if($APPLICATION->GetCurPage() == '/kanalizatsiya-dlya-doma/')
            echo 'Канализация для дома';
        elseif($APPLICATION->GetCurPage() == '/vodosnabzhenie/')
            echo 'Водоснабжение дома';
        elseif($APPLICATION->GetCurPage() == '/otoplenie/')
            echo 'Отопление от компании «Полимерстрой»';
        else
