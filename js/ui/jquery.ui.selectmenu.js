...
$.widget("ui.selectmenu", {
	...
	_create: function() {
		...
		this.newelement = $( '<a />', {
			'class': this.widgetBaseClass + ' ui-widget ui-state-default',
			'id' : this.ids[ 1 ],
			'role': 'button',
			'href': '#nogo',
				...
				var thisLi = $('<li/>', thisLiAttr)	
					...
					.bind('mouseover.selectmenu focus.selectmenu', function(e) {
						...
						if (!$(e.currentTarget).hasClass(self.namespace + '-state-disabled') && !$(e.currentTarget).parent("ul").parent("li").hasClass(self.namespace + '-state-disabled')) {
							...
							$(this).removeClass('ui-state-active').addClass(self.widgetBaseClass + '-item-focus');
						}
					})
	...
	open: function(event) {
		...
		if ( self.newelement.attr("aria-disabled") != 'true' ) {
			...
			if ( o.style == "dropdown" ) {
				self.newelement.removeClass('ui-corner-all');
			} else {				
